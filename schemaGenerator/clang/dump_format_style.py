# From https://github.com/llvm/llvm-project/blob/main/clang/docs/tools/dump_format_style.py
# Permament link: https://github.com/llvm/llvm-project/blob/10a1ea9b53647c1511d3cce8fa7637f8ffdb39b5/clang/docs/tools/dump_format_style.py
# With some modifications to export html instead of rst
# fmt: off
...
class OptionsReader:
    ...
    def __clean_comment_line(self, line: str):
        if line.strip() == "///" and not self.in_code_block:
            return "<p style='margin-top:5px'>"
    ...
    def read_options(self):
        ...
        return options, nested_structs, enums
